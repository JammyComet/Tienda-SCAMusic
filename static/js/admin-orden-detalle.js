function mostrarDetalleOrdenAdmin() {
    const contenedor = document.getElementById("detalleOrdenAdmin");
    ...
    if (!orden) {
        contenedor.innerHTML = `
            ...
            <a href="/admin/ordenes" class="btn btn-dark">Volver a órdenes</a>
        `;
        return;
    }
    ...
    contenedor.innerHTML = `
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
            <div>
                <p class="text-secondary mb-1">Administración / Órdenes / Detalle</p>
...
document.addEventListener("DOMContentLoaded", mostrarDetalleOrdenAdmin);
